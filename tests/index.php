...
$icons = getIcons($link);
$languages = getAllLanguagesInTable($link, 'tests');
?>
<!DOCTYPE html>
<html lang="ru">
    ...
    <div id="wrapper" class="light">
        ...
        <main id="main" class="tests">
            ...
            for ($i = 0; $i < sizeof($languages); $i++) {
                echo '<a href="/tests/list.php?lang=' . $languages[$i][0] . '" class="card" >' . $icons[$languages[$i][0]] . '<div class="card__title">' . ucfirst($languages[$i][0]) . '</div><div class="card__subtitle">Тестов: ' . getRowsCount($link, 'tests', $languages[$i][0]) . '</div></a>';
            }
            ?>
        </main>
    </div>
